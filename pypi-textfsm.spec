...
%prep
%setup -q -n textfsm-1.1.2
cd %{_builddir}/textfsm-1.1.2
pushd ..
cp -a textfsm-1.1.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656368913
...
cp %{_builddir}/textfsm-1.1.2/COPYING %{buildroot}/usr/share/package-licenses/pypi-textfsm/2b8b815229aa8a61e483fb4ba0588b8b6c491890
cp %{_builddir}/textfsm-1.1.2/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-textfsm/a8f3e29d5eab4420318de979754f5637d4bf2c3f
